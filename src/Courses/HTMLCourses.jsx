...
const HTMLCourses = () => {
  ...
  return (
    <div className="grid grid-cols-10 max-md:overflow-x-hidden max-md:grid-cols-1 px-5 pt-[13vh] gap-5 min-h-[100vh]">
      <div className="p-2 max-md:w-[95vw] my-0 mx-auto pb-10">
        <h2 className="text-center flex justify-center gap-4 items-center font-extrabold">
          {currentVideo.author} <FaHtml5 className="text-4xl" />
        </h2>
