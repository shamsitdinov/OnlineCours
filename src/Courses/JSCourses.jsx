...
import { CSS, JS } from "../dataCourses";
...
const JSCourses = () => {
  let [lesson, setLesson] = useState(JS);
  let [courseIndex, setCourseIndex] = useState(0);
  let [currentVideo, setCurrentVideo] = useState(JS[courseIndex]);
  ...
  return (
    ...
    <h2 className="text-center flex  gap-4 items-center font-extrabold">
      <IoLogoJavascript className="text-4xl" /> {currentVideo.author}
    </h2>
