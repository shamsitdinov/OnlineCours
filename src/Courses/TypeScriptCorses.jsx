...
import { CSS, JS, Reactjs, TypeScript } from "../dataCourses";
...
const TypeScriptCourses = () => {
  let [lesson, setLesson] = useState(TypeScript);
  let [courseIndex, setCourseIndex] = useState(0);
  let [currentVideo, setCurrentVideo] = useState(TypeScript[courseIndex]);
...
export default TypeScriptCourses;
